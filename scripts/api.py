...
def deforum_api(_: gr.Blocks, app: FastAPI):
    ...
    async def run_deforum_api(request: DeforumRequest):
        ...
        response = run_deforum(
            'task(unfo2dfq8ajiim3)',
            None, 
            False, 
            None, 
            '3D',
            ...
            'bicubic', 
            False, 
            'https://deforum.github.io/a1/V1.mp4', 
            1, 
            0, 
            -1, 
            False, 
            False, 
            'https://deforum.github.io/a1/VM1.mp4', 
            '0:(0.5)', 
            '0:(0.5)', 
            '0:(1)', 
            '0:(100)', 
            ...
            False,
            False, 
            'https://deforum.github.io/a1/M1.jpg', 
            False, 
            1.0, 
            1.0, 
            True, 
