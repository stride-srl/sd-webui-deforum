...
def deforum_api(_: gr.Blocks, app: FastAPI):
    ...
    @app.post("/deforum/run_deforum", response_model=DeforumResponse)
    async def run_deforum_api(request: DeforumRequest):
        ...
        #get filename from mp4_path = C:\stride\stable-diffusion-webui\outputs/images\Deforum_20230708020917\20230708020917.mp4
        filename = mp4_path.split('\\')[-1]
